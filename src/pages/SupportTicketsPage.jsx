...
const SupportTicketsPage = () => {
  const dummyTickets = [
    ...
    { id: 'TKT-8903', subject: 'Update branding guidelines', priority: 'Low', status: 'Resolved', date: 'Oct 20, 2024' },
    { id: 'TKT-8904', subject: 'Bug in mobile navigation', priority: 'High', status: 'Resolved', date: 'Oct 15, 2024' },
  ];
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Manage and track your technical support requests.</p>
        </div>
      ...
      <Card>
        <Table columns={columns} data={dummyTickets} />
      </Card>
    </div>
  );
};
