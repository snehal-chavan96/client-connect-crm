...
const ProjectTrackingPage = () => {
  ...
  const projects = role === 'admin' ? allProjects : clientProjects;
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">{role === 'admin' ? 'Monitor all projects' : 'Monitor the pulse of your ongoing initiatives.'}</p>
        </div>
      </div>
